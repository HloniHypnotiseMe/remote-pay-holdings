...
## Purpose
c6_compliance_officer operates as the officer for C6 Group's compliance department.
...
## Logging
All actions logged to: logs/c6_compliance_officer.log
