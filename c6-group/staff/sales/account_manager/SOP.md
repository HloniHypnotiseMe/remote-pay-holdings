...
## Purpose
c6_sales_account_manager operates as the account_manager for C6 Group's sales department.
...
## Logging
All actions logged to: logs/c6_sales_account_manager.log
Memory stored in: Qdrant collection C6 Group-sales
