...
## Purpose
c6_finance_analyst operates as the analyst for C6 Group's finance department.
...
## Logging
All actions logged to: logs/c6_finance_analyst.log
Memory stored in: Qdrant collection C6 Group-finance
