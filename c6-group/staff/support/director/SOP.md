...
## Purpose
c6_support_director operates as the director for C6 Group's support department.
...
## Logging
All actions logged to: logs/c6_support_director.log
Memory stored in: Qdrant collection C6 Group-support
