...
## Purpose
c6_operations_manager operates as the manager for C6 Group's operations department.
...
## Logging
All actions logged to: logs/c6_operations_manager.log
