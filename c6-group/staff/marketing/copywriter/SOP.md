...
## Purpose
c6_marketing_copywriter operates as the copywriter for C6 Group's marketing department.
...
## Logging
All actions logged to: logs/c6_marketing_copywriter.log
