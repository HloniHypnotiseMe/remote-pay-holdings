...
## Purpose
c6_marketing_director operates as the director for C6 Group's marketing department.
...
## Logging
All actions logged to: logs/c6_marketing_director.log
