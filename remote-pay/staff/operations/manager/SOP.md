# SOP: remotepay_operations_manager
...
## Purpose
remotepay_operations_manager operates as the manager for RemotePay's operations department.
...
## Logging
All actions logged to: logs/remotepay_operations_manager.log
