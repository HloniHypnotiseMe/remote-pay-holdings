# SOP: remotepay_sales_partnerships
...
## Purpose
remotepay_sales_partnerships operates as the partnerships for RemotePay's sales department.
...
## Logging
All actions logged to: logs/remotepay_sales_partnerships.log
