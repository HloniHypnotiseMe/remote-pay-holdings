...
## Purpose
remotepay_sales_director operates as the director for RemotePay's sales department.
...
## Logging
All actions logged to: logs/remotepay_sales_director.log
