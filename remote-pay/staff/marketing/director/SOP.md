# SOP: remotepay_marketing_director
...
## Purpose
remotepay_marketing_director operates as the director for RemotePay's marketing department.
...
## Logging
All actions logged to: logs/remotepay_marketing_director.log
