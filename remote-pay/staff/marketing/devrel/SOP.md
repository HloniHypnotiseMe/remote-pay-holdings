# SOP: remotepay_marketing_devrel
...
## Purpose
remotepay_marketing_devrel operates as the devrel for RemotePay's marketing department.
...
## Logging
All actions logged to: logs/remotepay_marketing_devrel.log
