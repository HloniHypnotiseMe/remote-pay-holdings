# SOP: remotepay_support_director
...
## Purpose
remotepay_support_director operates as the director for RemotePay's support department.
...
## Logging
All actions logged to: logs/remotepay_support_director.log
