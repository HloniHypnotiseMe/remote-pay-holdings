# SOP: remotepay_support_dev_support
...
## Purpose
remotepay_support_dev_support operates as the dev_support for RemotePay's support department.
...
## Logging
All actions logged to: logs/remotepay_support_dev_support.log
