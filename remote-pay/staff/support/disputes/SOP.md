# SOP: remotepay_support_disputes
...
## Purpose
remotepay_support_disputes operates as the disputes for RemotePay's support department.
...
## Logging
All actions logged to: logs/remotepay_support_disputes.log
