...
## Purpose
remotepay_compliance_fica operates as the fica for RemotePay's compliance department.
...
## Logging
All actions logged to: logs/remotepay_compliance_fica.log
Memory stored in: Qdrant collection RemotePay-compliance
