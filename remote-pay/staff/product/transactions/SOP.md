# SOP: remotepay_product_transactions
...
## Purpose
remotepay_product_transactions operates as the transactions for RemotePay's product department.
...
## Logging
All actions logged to: logs/remotepay_product_transactions.log
