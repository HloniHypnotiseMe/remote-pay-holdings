# SOP: remotepay_product_settlement
...
## Purpose
remotepay_product_settlement operates as the settlement for RemotePay's product department.
...
## Logging
All actions logged to: logs/remotepay_product_settlement.log
