...
## Purpose
remotepay_product_fraud operates as the fraud for RemotePay's product department.
...
## Logging
All actions logged to: logs/remotepay_product_fraud.log
