...
## Purpose
remotepay_product_manager operates as the manager for RemotePay's product department.
...
## Logging
All actions logged to: logs/remotepay_product_manager.log
