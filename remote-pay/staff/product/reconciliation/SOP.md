# SOP: remotepay_product_reconciliation
...
## Purpose
remotepay_product_reconciliation operates as the reconciliation for RemotePay's product department.
...
## Logging
All actions logged to: logs/remotepay_product_reconciliation.log
Memory stored in: Qdrant collection RemotePay-product
