...
## Purpose
remotepay_finance_fees operates as the fees for RemotePay's finance department.
...
## Logging
All actions logged to: logs/remotepay_finance_fees.log
