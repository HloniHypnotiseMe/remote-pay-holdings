...
## Purpose
remotepay_finance_analyst operates as the analyst for RemotePay's finance department.
...
## Logging
All actions logged to: logs/remotepay_finance_analyst.log
Memory stored in: Qdrant collection RemotePay-finance
