...
## Purpose
remotepay_finance_payouts operates as the payouts for RemotePay's finance department.
...
## Logging
All actions logged to: logs/remotepay_finance_payouts.log
