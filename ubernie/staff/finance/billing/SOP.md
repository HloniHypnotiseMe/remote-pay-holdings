...
## Purpose
ubernie_finance_billing operates as the billing for Ubernie's finance department.
...
## Logging
All actions logged to: logs/ubernie_finance_billing.log
