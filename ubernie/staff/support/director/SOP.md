...
## Purpose
ubernie_support_director operates as the director for Ubernie's support department.
...
## Logging
All actions logged to: logs/ubernie_support_director.log
