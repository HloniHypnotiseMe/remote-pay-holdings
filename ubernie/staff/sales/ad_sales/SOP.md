...
## Purpose
ubernie_sales_ad_sales operates as the ad_sales for Ubernie's sales department.
...
## Logging
All actions logged to: logs/ubernie_sales_ad_sales.log
