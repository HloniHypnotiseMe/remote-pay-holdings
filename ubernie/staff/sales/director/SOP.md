...
## Purpose
ubernie_sales_director operates as the director for Ubernie's sales department.
...
## Logging
All actions logged to: logs/ubernie_sales_director.log
