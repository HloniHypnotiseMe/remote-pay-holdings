...
## Purpose
ubernie_product_manager operates as the manager for Ubernie's product department.
...
## Logging
All actions logged to: logs/ubernie_product_manager.log
