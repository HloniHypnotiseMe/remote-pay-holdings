...
## Purpose
ubernie_product_lister operates as the lister for Ubernie's product department.
...
## Logging
All actions logged to: logs/ubernie_product_lister.log
