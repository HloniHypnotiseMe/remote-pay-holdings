...
## Purpose
ubernie_product_scraper operates as the scraper for Ubernie's product department.
...
## Logging
All actions logged to: logs/ubernie_product_scraper.log
