# SOP: ubernie_marketing_local_seo
...
## Purpose
ubernie_marketing_local_seo operates as the local_seo for Ubernie's marketing department.
...
## Logging
All actions logged to: logs/ubernie_marketing_local_seo.log
