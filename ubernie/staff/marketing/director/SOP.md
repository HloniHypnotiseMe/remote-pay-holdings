# SOP: ubernie_marketing_director
...
## Purpose
ubernie_marketing_director operates as the director for Ubernie's marketing department.
...
## Logging
All actions logged to: logs/ubernie_marketing_director.log
