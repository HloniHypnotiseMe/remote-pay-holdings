# SOP: ubernie_operations_manager
...
## Purpose
ubernie_operations_manager operates as the manager for Ubernie's operations department.
...
## Logging
All actions logged to: logs/ubernie_operations_manager.log
